...
@section('title')
<title>Country Edit | {{$country->name}}</title>
@endsection
                            ...
                            <div class="row">   
                                <div class="col-sm-12">
                                    <div class="form-group fill">  
                                        ...
                                        <input type="text" class="form-control form-control-sm @error('name') is-invalid @enderror" placeholder="Enter Name..." name="name" value="{{ $country->name }}" required/>
                                        @error('name')
