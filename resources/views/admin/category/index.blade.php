            ...
            <div class="page-block">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-4 text-md-right"> 
                        <a href="{{route('admin.category.create')}}" class="btn btn-success" title="Back to List"><i class="feather icon-plus"></i> Add Category</a> 
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="card-body"> 
                        <div class="table-responsive">
                            <table id="report-table" class="table table-sm table-bordered table-striped mb-0">
                                ...
                                <tbody>
                                	@if($category->count())
                                    @foreach($category as $index => $page)
                                    <tr>
                                        <td>{{$index+1}}</td>
                                        ...
                                        <td class="d-flex">  
                                            <a href="{{ route('admin.category.edit', $page->id) }}" class="btn btn-info btn-xs mr-1" title="Edit"><i class="feather icon-edit"></i></a>
                                            <form method="POST" action="{{ route('admin.category.destroy', $page->id) }}">
                                                @csrf
