                        ...
                        <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="{{ route('admin.unverified-seller.edit', $seller->id) }}" class="btn btn-soft-info btn-sm waves-effect waves-light" title="Edit"><i class="bx bx-pencil font-size-16"></i></a>
