                    ...
                    <ul class="clearfix">
                        <li class="item d-flex justify-content-center align-items-center">
                            <a class="product-image" href="#">
                                <img class="blur-up lazyload" src="images/products/1.jpg" alt="image" title="" width="100" height="120" />
                            </a>
                        ...
                        <li class="item d-flex justify-content-center align-items-center">
                            <a class="product-image" href="#">
                                <img class="blur-up lazyload" src="images/products/2.jpg" alt="image" title="" width="100" height="120">
                            </a>
                            <div class="product-details">
...
<!-- <div id="pro-addtocart-popup" class="mfp-with-anim mfp-hide">
    ...
    <div class="addtocart-inner text-center clearfix">
        ...
        <div class="pro-img mb-3">
            <img class="img-fluid blur-up lazyload" src="images/products/add-to-cart-popup.jpg" data-src="images/products/add-to-cart-popup.jpg" alt="Added to your shopping cart successfully." title="Added to your shopping cart successfully." width="600" height="508" />
        </div>
...
<!-- <div class="product-notification" id="dismiss">
    ...
    <div class="media d-flex">
        <a href="#"><img class="mr-2 blur-up lazyload" src="images/products/product-3.jpg" data-src="images/products/product-3.jpg" alt="Trim Button Front Blouse" /></a>
...
<!-- <div id="newsletter-modal" class="style1 mfp-with-anim mfp-hide">
    <div class="d-flex flex-column">
        <div class="newsltr-img d-none d-sm-none d-md-block"><img class="blur-up lazyload" src="images/newsletter-img.webp" data-src="images/newsletter-img.webp" alt="image" width="550" height="290"></div>
